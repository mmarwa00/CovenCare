        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              if (!result.success) {
                if (result.error?.toLowerCase().includes('already been redeemed')) {
              ...
              const updated = localSenders.map(s =>
                s.voucherId === sender.voucherId
                  ? { ...s, redeemed: true, redeemedAt: result.voucher?.redeemedAt || new Date() }
                  : s
              );
              ...
              const allRedeemed = updated.every(s => s.redeemed);
              if (allRedeemed) {
